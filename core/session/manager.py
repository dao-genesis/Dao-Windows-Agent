...
def default_session_root() -> str:
    """会话根目录：跨平台取系统临时目录（Windows 上为 %TEMP%，非硬编码 /tmp）。"""
    return os.path.join(tempfile.gettempdir(), "dao-win", "sessions")
...
class SessionManager:
    ...
    def __init__(self, registry: ProfileRegistry, root: Optional[str] = None):
