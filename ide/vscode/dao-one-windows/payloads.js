...
"  h+='<iframe id=\"wdesk_frame\" src=\"'+esc(WDESK.url)+'\" style=\"width:100%;height:calc(100vh - 210px);min-height:420px;border:1px solid var(--line);border-radius:8px;background:#000\" allow=\"clipboard-read; clipboard-write\"></iframe>';",
"  v.innerHTML=h;}",
